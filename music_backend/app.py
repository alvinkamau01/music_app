...
api.add_resource(EventResource, '/events')  # Removed trailing slash
api.add_resource(EventListResource, '/event/<int:event_id>')
api.add_resource(UserListResource,'/users')
api.add_resource(UserResource,'/user/<int:user_id>')
api.add_resource(TicketResource,'/tickets')
api.add_resource(TicketListResource,'/ticket/<int:song_request_id>')
